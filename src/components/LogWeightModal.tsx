  ...
  return (
    <div className='modal-wrapper' >
        ...
        <div className='d-flex' style={{flexDirection:'row-reverse'}}><button className='btn  mx-3 my-3' onClick={()=>setShow(false)}><i className="fa-solid fa-x"></i></button></div>
            ...
            <input required className="form-control w-50 table-font" step={0.1} value={value} onChange={(e)=>setValue(Number(e.target.value))} style={{height:'70px',fontSize:"30px"}} type="number" min={25} max={180} />
            </div>
